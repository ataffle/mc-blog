...
post_3 = { title: "Louis D, le beau gosse nous livre ses secrets", content: "Louis D a toujours rêvé de devenir agent immobilier. Aujourd'hui son rêve est devenu réalité. Phasellus ullamcorper ipsum rutrum nunc. Curabitur turpis. In turpis. Morbi mollis tellus ac sapien. Curabitur blandit mollis lacus.", category_id: 3, user_id: 1 }
